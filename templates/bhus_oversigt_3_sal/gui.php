    ...
    <div class="col-md-12" style="margin-top:20px;">
        ...
        if (sizeof($calendar_events) != 0) {
            ...
            foreach ($calendar_events as $page => $events) {
                ?>
                <table id="main-table" class="table  table-striped <?php echo "page_" . $page ?>" <?php if ($page != 0) {
                    ...
                    <tbody style="font-size:22px !important;">
                        ...
                        foreach ($events as $event) {
                            ...
                            <tr>
                                ...
                                <td style="width:20%;border-top-style:none;" class="col-md-5"><?php foreach ($locations as $index => $location) {
                                echo $index >= 1 ? "<br/>" . $location : $location;
                            } ?></td>
                            </tr>
                            <?php
                            $show_count++;
        ...
        if ($total_show <= 21) {
            echo '<div class="col-md-12" style="margin-top:100px;"><div class="col-md-3"></div><div class="col-md-6"><div id="widget"></div></div><div class="col-md-3"></div>';
            ?>
